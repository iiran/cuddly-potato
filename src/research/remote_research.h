...
#ifndef CUDDLY_POTATO_REMOTE_RESEARCH_H
#define CUDDLY_POTATO_REMOTE_RESEARCH_H
...
namespace iiran {
    ...
    const static char *DefaultUserAgent = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:6.0) Gecko/20100101 Firefox/6.0";
    ...
    public:
        ...
        explicit RemoteResearch(std::string out_path) : Research(std::move(out_path)) {};
...
#endif //CUDDLY_POTATO_REMOTE_RESEARCH_H
