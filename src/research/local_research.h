...
#ifndef CUDDLY_POTATO_LOCAL_RESEARCH_H
#define CUDDLY_POTATO_LOCAL_RESEARCH_H
...
namespace iiran {
    ...
    public:
        explicit LocalResearch(std::string out_path) : Research(std::move(out_path)) {};
    ...
    private:
        ...
        static void get_all_supported_local_recursive(const std::string &path, std::vector<std::string> &v_path) {
...
#endif //CUDDLY_POTATO_LOCAL_RESEARCH_H
